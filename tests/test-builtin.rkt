...
(define-test-suite builtin-tests
  ...
  (test-case "naturals-and-terms"
    ...
    (check-reduce test1 (div 5 2) 2)
    (check-reduce test1 (div 5 foo) (div 5 foo))
    (check-reduce test1 (div foo 3) (div foo 3))
    (check-reduce test1 (div foo 1) foo))
  ...
  (test-case "integers-and-terms"
    ...
    (check-reduce test2 (- 3 foo) (- 3 foo))
    (check-reduce test2 (- 0 foo) (- foo))
    (check-reduce test2 (- foo 0) foo)
    (check-reduce test2 (- foo foo) 0)
    (check-reduce test2 (* 2 -3) -6)
    (check-reduce test2 (* foo) foo)
    (check-reduce test2 (* foo foo) (* foo foo))
    (check-reduce test2 (* 2 foo) (* 2 foo))
    (check-reduce test2 (* 2 -3 foo) (* -6 foo))
    (check-reduce test2 (div -5 2) -2)
    (check-reduce test2 (div -5 foo) (div -5 foo))
    (check-reduce test2 (div foo -3) (div foo -3))
    (check-reduce test2 (div foo 1) foo))
  ...
  (test-case "rationale-and-terms"
    ...
    (check-reduce test3 (- 3/2 foo) (- 3/2 foo))
    (check-reduce test3 (- 0 foo) (- foo))
    (check-reduce test3 (- foo 0) foo)
    (check-reduce test3 (- foo foo) 0)
    ...
    (check-reduce test3 (/ 2 foo) (/ 2 foo))
    (check-reduce test3 (/ 1 foo) (/ foo))
    (check-reduce test3 (/ 0 foo) 0)
